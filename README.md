...
- **Evidence, not verdicts** — every observation carries the exact request/response it came from, a state (`Observation`, `Needs Verification`, `Potential Issue`, `Verified`, `Not Reproducible`) and a confidence level.
